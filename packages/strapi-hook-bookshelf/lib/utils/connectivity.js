...
module.exports = (scope, success, error) => {
  ...
  knex
              ...
              .prompt([
                {
                  ...
                  message: `Are you sure you want to continue with the ${
                    scope.database.settings.database
                  } database:`,
                },
              ])
              .then(({ confirm }) => {
    ...
    .catch(err => {
      ...
      if (err.sql) {
        console.log(
          '⚠️  Server connection has failed! Make sure your database server is running.'
        );
      } else {
        console.log(
          `⚠️  Database connection has failed! Make sure your "${
            scope.database.settings.database
          }" database exist.`
        );
      }
